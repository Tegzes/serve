...
*embedding_name* : The name of embedding layer in the chosen model, this could be `bert` for `bert-base-uncased`, `roberta` for `roberta-base`, `roberta` for `xlm-roberta-large`, or `gpt2` for `gpt2` model
